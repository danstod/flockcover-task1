...
describe('apiUtil', async () => {
    ...
    it('get all drones success', async () => {
        ...
        let result = await api.getAxiosResponse('/drones', 'drones');
        // console.log(result);
    ...
    it('get drones id = 1 success', async () => {
        ...
        let result = await api.getAxiosResponse('/drone/1', 'drone');
        // console.log(result);
        expect(result.data.statusCode).to.equal(200);
    ...
    it('get drones id = 100 success', async () => {
        ...
        let result = await api.getAxiosResponse('/drone/100', 'drone');
        // console.log(result);
